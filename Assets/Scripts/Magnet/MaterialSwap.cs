  ...
  private void Update() {
    ...
    if(GetComponent<Magnetic>().MagnetType!=_oldType) {
      if(GetComponent<Magnetic>().MagnetType==MagneticType.Blue) {
        ...
        if(GetComponent<Ball>()) {
          transform.Find("Blue").GetComponent<MeshRenderer>().enabled= true;
          transform.Find("Red").GetComponent<MeshRenderer>().enabled= false;
        }
        ...
        if(GetComponent<Ball>()) {
          transform.Find("Blue").GetComponent<MeshRenderer>().enabled=false;
          transform.Find("Red").GetComponent<MeshRenderer>().enabled=true;
          return;
        }
        if(transform.Find("PlayerColorIndication"))
